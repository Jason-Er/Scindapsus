...
public abstract class Voice implements VoiceModel{
    public static Voice create(long id, String audiourl_server, String audiourl_local, long user_id, long line_id) {
        return new AutoValue_Voice(id, audiourl_server, audiourl_local, user_id, line_id);
    }
    ...
    public static final Factory<Voice> FACTORY = new Factory<>(new Creator<Voice>() {
        @Override
        public Voice create(long id, String audiourl_server, String audiourl_local, long user_id, long line_id) {
            return new AutoValue_Voice(id, audiourl_server, audiourl_local, user_id, line_id);
        }
    });
}
